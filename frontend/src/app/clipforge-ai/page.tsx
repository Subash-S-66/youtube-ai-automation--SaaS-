...
export default function ClipForgeAiPage() {
  const breadcrumbSchema = buildBreadcrumbListSchema([
    { name: 'Home', path: '/' },
    { name: 'ClipForge AI', path: '/clipforge-ai' },
  ]);
    ...
    <main className="min-h-screen bg-[#0B0F1A] px-4 py-16 text-[#EAF2FF] md:px-8">
      <section itemScope itemType="https://schema.org/WebPage">
        <article className="mx-auto max-w-4xl rounded-2xl border border-[#28476F] bg-[#101A2D] p-6 md:p-10">
          <JsonLdScript id="clipforge-ai-breadcrumb-schema" data={breadcrumbSchema} />
          ...
          <section className="mt-8 rounded-xl border border-[#32507A] bg-[#0F1A2D] p-5">
            ...
            <dl className="mt-4 space-y-3 text-sm leading-relaxed text-[#BED4F3] md:text-base">
              <div>
                <dt className="font-semibold text-white">Hook-First Script Generation</dt>
                <dd>Produces intros and structured scripts designed for stronger retention.</dd>
              </div>
              <div>
                <dt className="font-semibold text-white">Narration and Pacing Controls</dt>
                <dd>Aligns voice delivery to topic intent and audience expectations.</dd>
              </div>
              <div>
                <dt className="font-semibold text-white">Visual Sequence Matching</dt>
                <dd>Pairs scenes and imagery to script flow for better relevance.</dd>
              </div>
              <div>
                <dt className="font-semibold text-white">Caption Styling Logic</dt>
                <dd>Maintains subtitle readability and branding consistency at scale.</dd>
              </div>
              <div>
                <dt className="font-semibold text-white">Publishing Pipeline Support</dt>
                <dd>Reduces last-mile friction for scheduling and posting clips.</dd>
              </div>
            </dl>
          </section>
          ...
          <section className="mt-6 rounded-xl border border-[#32507A] bg-[#0F1A2D] p-5">
            ...
            <p className="mt-4 leading-relaxed text-[#BED4F3] md:text-base">
              ...
              constraints such as clip length, call-to-action type, and whether the content should feel educational,
              narrative, or opinion-driven. The clearer your input, the more reliable your output. This lets the
              ClipForge app function as a production multiplier rather than a random content generator.
            </p>
            <p className="mt-4 leading-relaxed text-[#BED4F3] md:text-base">
          ...
          <div className="mt-8 flex flex-col gap-3 text-sm font-semibold md:flex-row">
            ...
            <Link
              ...
              aria-label="Read the ClipForge video tool guide"
              className="rounded-full border border-[#32507A] px-5 py-2.5 text-[#9DDCFF] transition hover:border-[#00D4FF]"
            >
            ...
            <Link
              href="/features"
              aria-label="Explore ClipForge platform features"
              className="rounded-full border border-[#32507A] px-5 py-2.5 text-[#9DDCFF] transition hover:border-[#00D4FF]"
            >
              Explore Features
            </Link>
            <Link
              ...
              aria-label="View ClipForge versus competitor comparison"
              className="rounded-full border border-[#32507A] px-5 py-2.5 text-[#9DDCFF] transition hover:border-[#00D4FF]"
            >
              ClipForge vs competitors
            </Link>
            <Link
              href="/register"
              aria-label="Try ClipForge AI for free"
